...
import { PlayPauseButton } from "./audio_controls/PlayPauseButton";
import { SkipButton } from "./audio_controls/SkipButton";
import { RewindButton } from "./audio_controls/RewindButton";
import { VolumeButton } from "./audio_controls/VolumeButton";
...
export const Radio = () => {
    ...
    return(
        <RadioContainer>
            <RadioInformation>
                <SongTitle>Le Music</SongTitle>
                <audio ref={audioRef} src={sahara_music} onEnded={()=>{setIsPlaying(false)}} onTimeUpdate={(e) => updateProgress(e)}/>
                <RadioControls>
                    <RewindButton></RewindButton>
                    <PlayPauseButton playingState={isPlaying} onClick={playback}></PlayPauseButton>
                    <SkipButton></SkipButton>
                </RadioControls>
                <PlaceHolder>
                    <VolumeButton volume={volume} volumeChanger={volumeChanger}></VolumeButton>
                </PlaceHolder>
            </RadioInformation>
